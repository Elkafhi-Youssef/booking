<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded sticky ">
  <div class="container flex flex-wrap justify-between items-center mx-auto">
    <a href="#" class="logo">
      <img height="25px" WIDTH="145px" src="./img/logo/bookingMaa.png" alt="logo">
    </a>
    ...
    <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="navbar-cta">
      <ul
        ...
        <li>
          <a href="reservation"
            class="block py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 ">Reservation</a>
        </li>
        <li>
          <a href="about"
