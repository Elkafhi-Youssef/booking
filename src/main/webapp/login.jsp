  ...
  <main class="w-screen h-screen flex flex-col items-center justify-center ">
    ...
    <form action="login" method="post">
      ...
      <div class="mb-6">
        ...
        <input type="password" name="psswd" id="psswd" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
      </div>
